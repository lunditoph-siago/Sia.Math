...
{
    private float3 _sa, _sb, _sc, _sd;
    private Vector3 _va, _vb, _vc, _vd;
    ...
    public void Sys_Remap() { var t = (_va - _va) / (_vb - _va); var r = Vector3.Lerp(_vc, _vd, t); Sink(r.X); }
